...
public class DrawableTools {
     ...
     * @return
     */
    public static Drawable bitmapToDrawable(Resources res,Bitmap srcBitmap){

        return new BitmapDrawable(res,srcBitmap);
    }
    ...
    public static Bitmap drawableToBitmap(Drawable drawable,Bitmap.Config config) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(intrinsicWidth, intrinsicHeight,
                config == null?Bitmap.Config.ARGB_8888:config);
     ...
     *
     *
     *以下代码感谢腾讯开源项目QMUI_Android：
     *来源：https://github.com/QMUI/QMUI_Android
     *
     *
     *
     *
